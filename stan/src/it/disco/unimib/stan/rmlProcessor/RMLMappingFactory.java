...
import it.disco.unimib.stan.rmlProcessor.Vocab.R2RMLTerm;
import it.disco.unimib.stan.rmlProcessor.Vocab.RMLTerm;
...
public abstract class RMLMappingFactory {
    ...
    private static Map<Resource, TriplesMap> extractTripleMapResources(
        ...
        if (statements.isEmpty()) {
            log.debug("[RMLMappingFactory:extractRMLMapping] No subject statement found. Exit...");
        } /*
