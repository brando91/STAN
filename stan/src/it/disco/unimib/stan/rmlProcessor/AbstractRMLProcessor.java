...
import static it.disco.unimib.stan.rmlProcessor.TermType.BLANK_NODE;
...
public abstract class AbstractRMLProcessor implements RMLProcessor {
     ...
     */
    @Override
    public Resource processSubjectMap(SesameDataSet dataset, SubjectMap subjectMap, HashMap<String, String> node) {       
        //Get the uri
        ...
        switch (subjectMap.getTermType()) {
            case IRI:
                ...
                break;
            case BLANK_NODE:
                subject = new BNodeImpl(RandomStringUtils.randomAlphanumeric(10));
                break;
            default:
                subject = new URIImpl(value);
        }
    ...
    @Override
    public List<String> processTermMap(TermMap map, HashMap<String, String> node) {
     ...
     */
    @Override
    public void processPredicateObjectMap(SesameDataSet dataset, Resource subject, PredicateObjectMap pom, HashMap<String, String> node, TriplesMap map) {
     ...
     */
    private List<URI> processPredicateMap(PredicateMap predicateMap, HashMap<String, String> node) {
        // Get the value
     ...
     * @return
     */
    public List<Value> processObjectMap(ObjectMap objectMap, HashMap<String, String> node) {
