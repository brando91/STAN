...
public class EntityValuesPerformance extends AbstractBenchmark{
	...
	public static void setUp() throws Exception{
		...
		fill(here + "categories_1.nt");
		fill(here + "categories_2.nt");
		types.closeWriter();
	...
	private static void fill(String path) throws Exception {
		new Triples(new InputFile(new File(path))).fill(types, new AcceptAll());
	}
}
